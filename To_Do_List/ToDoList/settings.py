...
SECRET_KEY = 'django-insecure-y!v7#cvo=tu^*eabwo^#m4c=tn&=jtkileylfhwx2!b$24^28c'
...
INSTALLED_APPS = [
    ...
    'todo.apps.TodoConfig',  # Registering the 'todo' app
]
...
LOGIN_URL = 'login'  # Redirects to login if a user tries to access a protected view
LOGIN_REDIRECT_URL = 'tasks'  # Where to go after a successful login
